...
async function clientResize(input: string | File, maxWidth: number, maxHeight: number): Promise<string> {
...
async function serverResize(inputStr: string, maxWidth: number, maxHeight: number): Promise<string> {
